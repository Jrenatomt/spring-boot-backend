...
import com.projeto.demo.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTesteDateBase() throws ParseException {
		// criando categorias
		...
		// add cliente
		Cliente cli1 = new Cliente(null, "Maria jose", "jrenatomt@gmail.com", "11211887707", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("991300456", "991300654"));
		cli1.addPerfil(Perfil.CLIENTE);

		Cliente cli2 = new Cliente(null, "Eduardo costa", "gabrielled.dias2@gmail.com", "11211887707",
		...
		Endereco e3 = new Endereco(null, "Rua floriano", "37", "salao 50", "centro", "58475123", cli2, c2);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("13/03/2019 15:00"),
				null);
